import { LikeDislikeDB, PLAYLIST_LIKE, PlaylistAndCreatorName, PlaylistDB } from "../models/Playlist";
...
export class PlaylistDatabase extends BaseDatabase {
    ...
    public getPlaylistsAndCreatorName = async (): Promise<PlaylistAndCreatorName[]> => {
        const result: PlaylistAndCreatorName[] = await BaseDatabase
            .connection(PlaylistDatabase.TABLE_PLAYLISTS)
            .select(
    ...
    public findPlaylistById = async (id: string): Promise<PlaylistDB | undefined> => {
    ...
    public findPlaylistWithCreatorNameById = async (id: string): Promise<PlaylistAndCreatorName | undefined> => {
        ...
        return result as PlaylistAndCreatorName | undefined
    }
